...
class BiLSTMWindowRobMMT1Legacy(DailyStrategy):
	def possiblyOperationMorning(self, data):
		res = self.calculatePrediction(data)
		print(f'BiLSTMWindowRobMMT1Legacy res {res}')
	...
	def calculatePrediction(self, data):
		...
		print(f'BiLSTMWindowRobMMT1Legacy {y_mean}, actual value {data.Open.values[-1]}')
...
def fit_ensemble(n_members, X_train, X_test, y_train, y_test, epochs, batch_size):
	...
	for i in range(n_members):
		...
		print(f'BiLSTMWindowRobMMT1Legacy yhat {yhat}, member {i}')

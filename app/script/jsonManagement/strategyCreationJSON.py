...
param3 = InputParameter('Signal', 34)
inputs.append(StrategyInput('macd', '', 'macd_fW1_sW41_signal34', 'macd', [param1, param2, param3]))
lstmWindowRobMMT2Strategy = Strategy('lstmWindowRobMMT2_25_1_2023', '', inputs)
jsonmanager.addStrategy(lstmWindowRobMMT2Strategy)
...
param3 = InputParameter('Signal', 34)
inputs.append(StrategyInput('macd', '', 'macd_fW1_sW41_signal34', 'macd', [param1, param2, param3]))
bilstmWindowRobMMT1LegacyStrategy = Strategy('bilstmWindowRobMMT1Legacy_25_1_2023', '', inputs)
jsonmanager.addStrategy(bilstmWindowRobMMT1LegacyStrategy)

...
inputs.append(StrategyInput('bb_lband_w31_stdDev3.5483563609690094', '', 'bb_lband_w31_stdDev3.5483563609690094', 'lband', [param1, param2]))
# Diff_open
inputs.append(StrategyInput('Diff_open', '', 'Diff_open', '', []))
# rsi_w44
param1 = InputParameter('Window', 44)
inputs.append(StrategyInput('rsi_w44', '', 'rsi_w44', 'rsi', [param1]))
# adx_neg_w14
param1 = InputParameter('Window', 14)
inputs.append(StrategyInput('adx_neg_w14', '', 'adx_neg_w14', 'adx_neg', [param1]))
# stochRsi_d_w4_s131_s27
param1 = InputParameter('Window', 4)
param2 = InputParameter('Smooth1', 31)
param3 = InputParameter('Smooth2', 7)
inputs.append(StrategyInput('stochRsi_d_w4_s131_s27', '', 'stochRsi_d_w4_s131_s27', 'd', [param1, param2, param3]))
# adx_w50
param1 = InputParameter('Window', 50)
inputs.append(StrategyInput('adx_w50', '', 'adx_w50', 'adx', [param1]))
# Return_intra
inputs.append(StrategyInput('Return_intraday', '', 'Return_intraday', '', []))
...
inputs.append(StrategyInput('macd_difffW12_sW44_signal3', '', 'macd_difffW12_sW44_signal3', 'diff', [param1, param2, param3]))
# stochRsi_d_w50_s110_s218
param1 = InputParameter('Window', 50)
param2 = InputParameter('Smooth1', 10)
param3 = InputParameter('Smooth2', 18)
inputs.append(StrategyInput('stochRsi_d_w50_s110_s218', '', 'stochRsi_d_w50_s110_s218', 'd', [param1, param2, param3]))
# stochRsi_d_w3_s132_s247
param1 = InputParameter('Window', 3)
param2 = InputParameter('Smooth1', 32)
param3 = InputParameter('Smooth2', 47)
inputs.append(StrategyInput('stochRsi_d_w3_s132_s247', '', 'stochRsi_d_w3_s132_s247', 'd', [param1, param2, param3]))

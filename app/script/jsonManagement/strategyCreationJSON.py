...
rfClass = Strategy('RFClassifier', 'Strategy based on rfClassifier', inputs)
jsonmanager.addStrategy(rfClass)
...
inputs = []
# Open
inputs.append(StrategyInput('Open', '', 'Open', 'Natural', []))
# Close
inputs.append(StrategyInput('Close', '', 'Close', 'Natural', []))
# Volume
inputs.append(StrategyInput('Volume', '', 'Volume', '', []))
# High
inputs.append(StrategyInput('High', '', 'High', '', []))
# Low
inputs.append(StrategyInput('Low', '', 'Low', '', []))

lstmWindow = Strategy('lstmWindow', 'Strategy based on lstmWindow', inputs)
...
param3 = InputParameter('Smooth2', 19)
inputs.append(StrategyInput('stochasticRsi', '', 'stochRsi_k_w29_s18_s219', 'k', [param1, param2, param3]))
lstmEnsemble1 = Strategy('lstmEnsemble1', 'Strategy based on LSTM prediction of intraday return', inputs)
jsonmanager.addStrategy(lstmEnsemble1)
...
param3 = InputParameter('Smooth2', 19)
inputs.append(StrategyInput('stochasticRsi', '', 'stochRsi_k_w29_s18_s219', 'k', [param1, param2, param3]))
lstmEnsemble2 = Strategy('lstmEnsemble2', 'Strategy based on LSTM prediction of intraday return', inputs)
jsonmanager.addStrategy(lstmEnsemble2)
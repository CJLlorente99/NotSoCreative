...
def windowDailyDigest():
	...
	button_subscribe = ctk.CTkButton(frame_buttons, text="Subscribe",
									 command=subscribeCallback, corner_radius=15)
	...
	button_unsubscribe = ctk.CTkButton(frame_buttons, text="Unsubscribe",
									   command=unsubscribeCallback, corner_radius=15)
...
switch_color = ctk.CTkSwitch(sidebar_frame, text="Colorblind Mode    ", variable=color_var, command=update, onvalue=False,
						 offvalue=True, corner_radius=15)
...
# Scaling menu
scaling_optionmenu = ctk.CTkOptionMenu(sidebar_frame, values=["80%", "90%"], command=update, corner_radius=15)
...
# Send email button
send_email_button= ctk.CTkButton(sidebar_frame, text="Send Email to NotSoCreative", command=openEmail, fg_color='#FFFDC2', text_color='black', corner_radius=20)
send_email_button.pack(side=BOTTOM, padx=0.014*ws, pady=(0.017*hs, 0.017*hs))

# Daily digest button
daily_digest_button= ctk.CTkButton(sidebar_frame, text="Daily Digest\nSuscribe/Unsuscribe", command=windowDailyDigest, text_color='black', corner_radius=20)

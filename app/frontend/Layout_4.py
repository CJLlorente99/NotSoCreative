...
#-------------------------------------------
# Plot candlesticks
# mpf.plot(data_n, type='candle', title="Candlestick Plot 1", volume=False)
#'''
...
#plt.style.use("bmh")
fig, _ = mpf.plot(data_n, type='candlestick', volume=True, returnfig=True, figscale=2.0)
canvas = FigureCanvasTkAgg(fig, frame_m)
canvas.draw()

...
class InvestorLSTMWindowMinMaxT2Legacy (Investor):
	...
	def returnBrokerUpdate(self, moneyInvestedToday, data) -> pd.DataFrame:
		return pd.DataFrame(
			{'moneyToInvestLSTMWindowMinMaxT2Legacy': moneyInvestedToday,
			 'investedMoneyLSTMWindowMinMaxT2Legacy': self.investedMoney,
			 'nonInvestedMoneyLSTMWindowMinMaxT2Legacy': self.nonInvestedMoney}, index=[0])
	...
	def plotEvolution(self, expData, stockMarketData, recordPredictedValue=None):
		...
		fig.update_layout(
			title="Evolution of Porfolio using LSTM Window MM T2 Legacy (" + self.record.index[0].strftime(
				"%d/%m/%Y") + "-" +
				  self.record.index[-1].strftime("%d/%m/%Y") + ")", xaxis_title="Date",
			yaxis_title="Value [$]", hovermode='x unified')
		fig.write_image("images/EvolutionPorfolioLSTMWindowMMT2Legacy(" + self.record.index[0].strftime(
			"%d_%m_%Y") + "-" +
		...
		fig.update_layout(
			title="Decision making under LSTM Window MM T2 Legacy(" + self.record.index[0].strftime("%d/%m/%Y") + "-" +
				  self.record.index[-1].strftime("%d/%m/%Y") + ")", hovermode='x unified')
		fig.write_image("images/DecisionMakingLSTMWindowMMT2Legacy(" + self.record.index[0].strftime("%d_%m_%Y") + "-" +
						self.record.index[-1].strftime("%d_%m_%Y") + ").png", scale=6, width=1080, height=1080)
...
class InvestorLSTMWindowMinMaxT1Legacy (Investor):
	...
	def returnBrokerUpdate(self, moneyInvestedToday, data) -> pd.DataFrame:
		return pd.DataFrame(
			{'moneyToInvestLSTMWindowMinMaxT1Legacy': moneyInvestedToday,
			 'investedMoneyLSTMWindowMinMaxT1Legacy': self.investedMoney,
			 'nonInvestedMoneyLSTMWindowMinMaxT1Legacy': self.nonInvestedMoney}, index=[0])
	...
	def plotEvolution(self, expData, stockMarketData, recordPredictedValue=None):
		...
		fig.add_trace(go.Scatter(name="Total Value", x=self.record.index, y=self.record["totalValue"]))
		fig.update_layout(
			title="Evolution of Porfolio using LSTM Window MM T1 Legacy(" + self.record.index[0].strftime(
				"%d/%m/%Y") + "-" +
				  self.record.index[-1].strftime("%d/%m/%Y") + ")", xaxis_title="Date",
			yaxis_title="Value [$]", hovermode='x unified')
		fig.write_image("images/EvolutionPorfolioLSTMWindowMMT1Legacy(" + self.record.index[0].strftime(
			"%d_%m_%Y") + "-" +
						self.record.index[-1].strftime("%d_%m_%Y") + ").png", scale=6, width=1080, height=1080)
		# fig.show()
		...
		fig.update_xaxes(title_text="Date", row=2, col=1)
		fig.update_layout(
			title="Decision making under LSTM Window MM T1 Legacy(" + self.record.index[0].strftime("%d/%m/%Y") + "-" +
				  self.record.index[-1].strftime("%d/%m/%Y") + ")", hovermode='x unified')
		fig.write_image("images/DecisionMakingLSTMWindowMMT1Legacy(" + self.record.index[0].strftime("%d_%m_%Y") + "-" +
						self.record.index[-1].strftime("%d_%m_%Y") + ").png", scale=6, width=1080, height=1080)
...
class InvestorLSTMWindowMinMaxT1T2Legacy (Investor):
	...
	def returnBrokerUpdate(self, moneyInvestedToday, data) -> pd.DataFrame:
		return pd.DataFrame(
			{'moneyToInvestLSTMWindowMinMaxT1T2Legacy': moneyInvestedToday,
			 'investedMoneyLSTMWindowMinMaxT1T2Legacy': self.investedMoney,
			 'nonInvestedMoneyLSTMWindowMinMaxT1T2Legacy': self.nonInvestedMoney}, index=[0])
	...
	def plotEvolution(self, expData, stockMarketData, recordPredictedValue=None):
		...
		fig.add_trace(go.Scatter(name="Total Value", x=self.record.index, y=self.record["totalValue"]))
		fig.update_layout(
			title="Evolution of Porfolio using LSTM Window MM T1T2 Legacy(" + self.record.index[0].strftime(
				"%d/%m/%Y") + "-" +
				  self.record.index[-1].strftime("%d/%m/%Y") + ")", xaxis_title="Date",
			yaxis_title="Value [$]", hovermode='x unified')
		fig.write_image("images/EvolutionPorfolioLSTMWindowMMT1T2Legacy(" + self.record.index[0].strftime(
			"%d_%m_%Y") + "-" +
						self.record.index[-1].strftime("%d_%m_%Y") + ").png", scale=6, width=1080, height=1080)
		# fig.show()
		...
		fig.update_xaxes(title_text="Date", row=2, col=1)
		fig.update_layout(
			title="Decision making under LSTM Window MM T1T2 Legacy(" + self.record.index[0].strftime("%d/%m/%Y") + "-" +
				  self.record.index[-1].strftime("%d/%m/%Y") + ")", hovermode='x unified')
		fig.write_image("images/DecisionMakingLSTMWindowMMT1T2Legacy(" + self.record.index[0].strftime("%d_%m_%Y") + "-" +
						self.record.index[-1].strftime("%d_%m_%Y") + ").png", scale=6, width=1080, height=1080)

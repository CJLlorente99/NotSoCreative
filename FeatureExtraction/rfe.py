...
rfe_selector = RFE(estimator=RandomForestRegressor(), n_features_to_select=20, step=2, verbose=1)
...
rfe_selector = RFE(estimator=RandomForestClassifier(), n_features_to_select=20, step=2, verbose=1)
